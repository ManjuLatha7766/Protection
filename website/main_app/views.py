...
def emergency(request):
    ...
    errors = ""
    try:
        sendSms("6304602370", message)
    except:
        errors += "Message not send to 6304602370"
        pass
    try:
        sendSms("6303761671", message)
    except:
        errors += "Message not send to 6303761671"
        pass

    for c in contacts:
        send_mail(c.email, message)

    admin = [["manju", "6304602370"], ["divya", "6303761671"]]
